...
export declare const specializedChatWrapperTypeNames: readonly ["general", "deepSeek", "llama3.2-lightweight", "llama3.1", "llama3", "llama2Chat", "mistral", "alpacaChat", "functionary", "chatML", "falconChat", "gemma"];
...
export declare const resolvableChatWrapperTypeNames: readonly ["auto", "general", "deepSeek", "llama3.2-lightweight", "llama3.1", "llama3", "llama2Chat", "mistral", "alpacaChat", "functionary", "chatML", "falconChat", "gemma", "template", "jinjaTemplate"];
