...
/** @hidden */
type ProhibitUnknownProperties<BaseType, Input extends BaseType> = BaseType extends object ? Input extends object ? (Input & {
    [K in Exclude<keyof Input, keyof BaseType>]: never;
} & {
    [K in keyof BaseType]: K extends keyof Input ? ProhibitUnknownProperties<BaseType[K], Input[K]> : BaseType[K];
}) : never : Input;
export {};
